...
namespace Xamarin.Essentials
{
    /// <summary>
    /// Copy from
    /// https://github.com/xamarin/Essentials/blob/aab19bb928332e737c6957e8df45c1c7f2e722cb/Xamarin.Essentials/FilePicker/FilePicker.win32.cs
    /// </summary>
    ...
    public partial class FilePickerFileType
    {
        public static FilePickerFileType PlatformImageFileType() =>
            ...
            {
                { DevicePlatform.WPF, new[] { "*.png", "*.jpg", "*.jpeg", "*.gif", "*.bmp" } }
            });

        public static FilePickerFileType PlatformPngFileType() =>
            new FilePickerFileType(new Dictionary<DevicePlatform, IEnumerable<string>>
            {
                { DevicePlatform.WPF, new[] { "*.png" } }
            });

        public static FilePickerFileType PlatformVideoFileType() =>
           new FilePickerFileType(new Dictionary<DevicePlatform, IEnumerable<string>>
           {
                { DevicePlatform.WPF, new[] { "*.mp4", "*.mov", "*.avi", "*.wmv", "*.m4v", "*.mpg", "*.mpeg", "*.mp2", "*.mkv", "*.flv", "*.gifv", "*.qt" } }
           });
    }
}

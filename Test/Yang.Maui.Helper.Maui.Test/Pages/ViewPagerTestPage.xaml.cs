...
public partial class ViewPagerTestPage : ContentPage
{
	...
	{
		InitializeComponent();
        var firstViewPage = new Grid() { BackgroundColor = Colors.AliceBlue, Children = { new EnhanceGraphicsViewDrawTextDemo() } };
        var secondViewPage = new Grid() { BackgroundColor = Colors.AliceBlue };
        var thirdViewPage = new Grid() { BackgroundColor = Colors.AliceBlue, Children = { new SkiaTextDrawDemo() } };

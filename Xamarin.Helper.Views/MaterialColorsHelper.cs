...
{
    /// <summary>
    /// Google Material Design Color 的hexStringCode(十六进制)
    /// </summary>
    public static class MaterialColorsHelper
    {
...
#region Convert Code
        ...
        public static RGB ToRGB(this string hexColorCode)
        {
            ...
            int argb = Int32.Parse(hexColorCode.Replace("#", ""), NumberStyles.HexNumber);
            return new RGB()
            {
                R = (byte)((argb & 0xff0000) >> 0x10),

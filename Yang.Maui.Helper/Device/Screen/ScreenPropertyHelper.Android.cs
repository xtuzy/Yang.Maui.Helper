...
namespace Yang.Maui.Helper.Device.Screen
{
    ...
    public partial class ScreenPropertyHelper
    {
        ...
        /// <summary>
        /// �ο�<see href="https://stackoverflow.com/questions/2661536/how-to-programmatically-take-a-screenshot-on-android?answertab=trending#tab-top"/>
        /// ��ͼ�ж������,���糤��ͼ,��̨��ͼ,����ֻ�����ڵ�ǰApp�ڵĿɼ������ͼ
        /// </summary>

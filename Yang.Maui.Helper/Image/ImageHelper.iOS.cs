...
namespace Yang.Maui.Helper.Image
{
    ...
    public static partial class ImageHelper
    {
        ...
        /// <returns></returns>
        public static UIImage DownSample(string imageUrl, CGSize pointSize, float scale)
        {
        ...
        /// <param name="scale">?</param>
        /// <returns></returns>
        public static UIImage DownSample(NSUrl imageURL, CGSize pointSize, float scale)
        {
            var imageSourceOptions = new CGImageOptions() { ShouldCache = false };

...
namespace Yang.Maui.Helper.Platforms.Android.Layouts
{
    ...
    /// 设置太多了,不好用
    /// </summary>
    public static class ConstraintLayoutHelper
    {
        /// <summary>
        ...
        public static ConstraintSet AddCenter(this ConstraintSet set, View view, View toFirstView, NSLayoutAttribute firstSide, View toSecondView, NSLayoutAttribute secondSide, int firstSideMargin = 0, int secondSideMargin = 0)
        {
            ...
            {
                set.Connect(view.Id, (int)NSLayoutAttribute.Left, toFirstView.Id, (int)firstSide, firstSideMargin);
                set.Connect(view.Id, (int)NSLayoutAttribute.Right, toSecondView.Id, (int)secondSide, secondSideMargin);
            ...
            {
                set.Connect(view.Id, (int)NSLayoutAttribute.Leading, toFirstView.Id, (int)firstSide, firstSideMargin);
                set.Connect(view.Id, (int)NSLayoutAttribute.Trailing, toSecondView.Id, (int)secondSide, secondSideMargin);
                //Constraint constraint = mConstraints.get(centerID);
                //constraint.horizontalBias = bias;
            }
            else
            {
                set.Connect(view.Id, (int)NSLayoutAttribute.Top, toFirstView.Id, (int)firstSide, firstSideMargin);
                set.Connect(view.Id, (int)NSLayoutAttribute.Bottom, toSecondView.Id, (int)secondSide, secondSideMargin);
                //Constraint constraint = mConstraints.get(centerID);
        ...
        public static ConstraintSet AddCenterH(this ConstraintSet set, View view, View toView)
        {
            ...
            set.Connect(view.Id, (int)NSLayoutAttribute.Leading, toView.Id, (int)NSLayoutAttribute.Leading);
            set.Connect(view.Id, (int)NSLayoutAttribute.Trailing, toView.Id, (int)NSLayoutAttribute.Trailing);
            return set;
        }
        ...
        public static ConstraintSet AddCenterV(this ConstraintSet set, View view, View toView)
        {
            ...
            set.Connect(view.Id, (int)NSLayoutAttribute.Top, toView.Id, (int)NSLayoutAttribute.Top);
            set.Connect(view.Id, (int)NSLayoutAttribute.Bottom, toView.Id, (int)NSLayoutAttribute.Bottom);
            return set;
        }
        ...
        public static ConstraintSet AddConnect(this ConstraintSet set, View view, NSLayoutAttribute startSide, View secondView, NSLayoutAttribute endSide, int biasMargins = 0)
        {
                ...
                )
            {
                ...
                if (biasMargins != 0)
                {
                    ...
                    line.LayoutParameters = new ConstraintLayout.LayoutParams(0, 0);
                    ((ConstraintLayout)parent).AddView(line);
                    set.Connect(line.Id, (int)NSLayoutAttribute.Top, secondView.Id, (int)NSLayoutAttribute.Top);
                    if (biasMargins < 0)
                    {
                        //bias小于0,辅助线的右边在endside的左边
                        if (startSide == NSLayoutAttribute.Left || startSide == NSLayoutAttribute.Right)
                        {
                            set.Connect(line.Id, (int)NSLayoutAttribute.Right, secondView.Id, (int)endSide, -biasMargins);//TODO:测试Leading,Trailing有无问题
                            set.Connect(view.Id, (int)startSide, line.Id, (int)NSLayoutAttribute.Right);
                        }
                        else// if (startSide == NSLayoutAttribute.Leading || startSide == NSLayoutAttribute.Trailing)
                        {
                            set.Connect(line.Id, (int)NSLayoutAttribute.Trailing, secondView.Id, (int)endSide, -biasMargins);//TODO:测试Leading,Trailing有无问题
                            set.Connect(view.Id, (int)startSide, line.Id, (int)NSLayoutAttribute.Trailing);
                        }
                    }
                    else
                    {
                        ...
                        if (startSide == NSLayoutAttribute.Left || startSide == NSLayoutAttribute.Right)
                        {
                            set.Connect(line.Id, (int)NSLayoutAttribute.Left, secondView.Id, (int)endSide, biasMargins);
                            set.Connect(view.Id, (int)startSide, line.Id, (int)NSLayoutAttribute.Left);
                        }
                        else// if (startSide == NSLayoutAttribute.Leading || startSide == NSLayoutAttribute.Trailing || )
                        {
                            set.Connect(line.Id, (int)NSLayoutAttribute.Leading, secondView.Id, (int)endSide, biasMargins);
                            set.Connect(view.Id, (int)startSide, line.Id, (int)NSLayoutAttribute.Leading);
                        }
                    }
                }
                else
                {
                    set.Connect(view.Id, (int)startSide, secondView.Id, (int)endSide);
                }
            ...
            if (biasMargins != 0)
            {
                ...
                set.Connect(line.Id, (int)NSLayoutAttribute.Leading, secondView.Id, (int)NSLayoutAttribute.Leading);
                if (biasMargins < 0)
                {
                    //bias小于0,辅助线的右边在endside的左边
                    set.Connect(line.Id, (int)NSLayoutAttribute.Bottom, secondView.Id, (int)endSide, -biasMargins);
                    set.Connect(view.Id, (int)startSide, line.Id, (int)NSLayoutAttribute.Bottom);
                }
                else
                {
                    //bias大于0,辅助线左边在endsize的右边
                    set.Connect(line.Id, (int)NSLayoutAttribute.Top, secondView.Id, (int)endSide, biasMargins);
                    set.Connect(view.Id, (int)startSide, line.Id, (int)NSLayoutAttribute.Top);
                }
                return set;
   ...
   /* public static class ConstrantLayoutParamsHelper
    {
        ...
        public static View LeftToLeft(this View view, View secondView, int margin = 0)
        {
            if (margin == 0)
            {
                ((ConstraintLayout.LayoutParams)view.LayoutParameters).LeftToLeft = secondView.Id;
                return view;
            }
